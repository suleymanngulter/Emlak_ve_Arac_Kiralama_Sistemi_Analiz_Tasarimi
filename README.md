Emlak ve Araç Kiralama sistemine dair analizle(kaynak, hukuksal, teknolojik fizibilite) başlayıp analizler sonucu oluşturduğumuz tasarımları ele aldığımız bir proje.
projede sırasıyla:
